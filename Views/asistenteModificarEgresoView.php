...
<html lang="en">
    <head>
        ...
        <title>Kronos │ Asistente - Modificar Egreso</title>
    </head>
    <br>
    ...
    <body>
        <div id="div_container">
            <div id="div_crearUsuario">
                <form id="form_crearUsuario" action='./?pag=asistente/modificarEgreso' method="POST">
                    <label>Id:</label>
                    ...
                    <label>Monto:</label>
                    <input type="number" step="0.01"  name="monto" value="<?php print $montoPositivo;?>"><br><br>
                    <label>Fecha:</label>
                    <input type="date" name="fecha" value="<?php print $dataModel[0]["Fecha_Transaccion"];?>"><br><br>
                    <div id="button_container_crearUsuario">
                        <center><button id="button_crearUsuario"type="submit">Modificar Egreso</button></center>
                    </div>
                </form>
            </div>
        </div>
