...
<html>
    <head>
        ...
        <title>Kronos │ Administrador - Ingresos</title>
    </head>
    <body>
        <br>
                ...
                <table id="user-table">
                    ...
                    <tbody>
                        ...
                        for ($i=0; $i < count($dataModel); $i++) { 
                            ...
                            print "<td><a href='./?pag=administrador/modificarIngreso/".$dataModel[$i]["Id_Transaccion"]."'><button style=\"background-color: yellow; font-weight: bold;\">Modificar</button></a></td>";
                            print "<td><a href='./?pag=administrador/borrarIngreso/".$dataModel[$i]["Id_Transaccion"]."'><button style=\"background-color: red; font-weight: bold;\">Borrar</button></a></td>";
                            print "</tr>";
                        }
                        ?>
                    </tbody>
        ...
        <center><a href="./?pag=administrador/crearIngreso"><button style="background-color: green; border: 2px solid green;" id="action_button">Nuevo Ingreso</button></a></center>
        <br><br>
    </body>
</html>