...
<html>
	<head>
		...
		<title>Kronos │ Administrador - Reportes</title>
	</head>
	<body>
	<br>
    ...
    <a href="./?pag=administrador"><button id="action_button">Volver</button></a>
		<div id="button_container_perfiles">
			<center><a href="./?pag=administrador/reporteUsuarios"><button>REPORTE DE USUARIOS</button></a><br><br></center>
			<center><a href="./?pag=administrador/reporteFinanciero"><button>REPORTE FINANCIERO</button></a><br><br></center>
		</div>	
	<br><br>
	</body>
</html>