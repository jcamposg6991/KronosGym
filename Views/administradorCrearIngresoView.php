...
<html lang="en">
    <head>
        ...
        <title>Kronos │ Administrador - Crear Ingreso</title>
    </head>
    <br>
    ...
    <a href="./?pag=administrador/ingresos"><button id="action_button">Volver</button></a>
    <body>
        <div id="div_container">
            <div id="div_crearUsuario">
                <form id="form_crearUsuario" action='./?pag=administrador/crearIngreso' method="POST">
                    ...
                    <div id="button_container_crearUsuario">
                        <center><button id="button_crearUsuario"type="submit">Crear Ingreso</button></center>
                    </div>
                </form>
            </div>
        </div>
