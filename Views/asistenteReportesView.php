...
<html>
	<head>
		...
		<title>Kronos │ Asistente - Reportes</title>
	</head>
	<body>
	<br>
    ...
    <a href="./?pag=asistente"><button id="action_button">Volver</button></a>
		<div id="button_container_perfiles">
			<center><a href="./?pag=asistente/reporteUsuarios"><button>REPORTE DE USUARIOS</button></a><br><br></center>
			<center><a href="./?pag=asistente/reporteFinanciero"><button>REPORTE FINANCIERO</button></a><br><br></center>
		</div>	
	<br><br>
	</body>
</html>