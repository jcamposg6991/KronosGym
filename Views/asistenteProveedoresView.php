...
<html>
    <head>
        ...
        <title>Kronos │ Asistente - Proveedores</title>
    </head>
    <body>
        <br>
                ...
                <table id="user-table">
                    ...
                    <tbody>
                        ...
                        for ($i=0; $i < count($dataModel); $i++) { 
                            ...
                            print "<td><a href='./?pag=asistente/modificarProveedor/".$dataModel[$i]["Id_Proveedor"]."'><button style=\"background-color: yellow; font-weight: bold;\">Modificar</button></a></td>";
                            /*print "<td><a href='./?pag=asistente/borrarProveedor/".$dataModel[$i]["Id_Proveedor"]."'><button style=\"background-color: red; font-weight: bold;\">Borrar</button></a></td>";*/
                            print "</tr>";
                        }
                        ?>
                    </tbody>
        ...
        <center><a href="./?pag=asistente/crearProveedor"><button style="background-color: green; border: 2px solid green;" id="action_button">Nuevo Proveedor</button></a></center>
        <br><br>
    </body>
</html>