...
<head>
    ...
    <title>Kronos │ Asistente - Reporte Usuarios</title>
</head>
<body>
<br>
    ...
    <div id="div_email">
        <form id="form_email">
            <div id="filter-container">
                ...
                <label for="id-perfil-filter">Filtrar por ID de Perfil:</label>
                <input type="text" id="id-perfil-filter">
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function applyFilters() {
        ...
        tableRows.forEach(row => {
            ...
            const showRow =
                ...
                (idPerfilFilter === '' || idPerfilValue === idPerfilFilter);
    ...
    function clearFilters() {
        ...
        document.getElementById('id-perfil-filter').value = '';
        applyFilters();
    }
