<?php
    ...
    $montoPositivo = substr($dataModel[0]["Monto"], 1);
?>
...
<html lang="en">
    <head>
        ...
        <title>Kronos │ Asistente - Borrar Egreso</title>
        <script>
        function confirmarBorrado() {
            var confirmacion = confirm("¿Realmente desea borrar el egreso?");
            if (confirmacion) {
    ...
    <a href="./?pag=asistente/egresos"><button id="action_button">Volver</button></a>
    <body>
        <div id="div_container">
            <div id="div_crearUsuario">
                <form id="form_crearUsuario" action='./?pag=asistente/borrarEgreso' method="POST">
                    <label>Id:</label>
                    ...
                    <label>Monto:</label>
                    <input type="number" step="0.01"  name="monto" value="<?php print $montoPositivo;?>" readonly><br><br>
                    <label>Fecha:</label>
                    ...
                    <div id="button_container_crearUsuario">
                        <center><button id="button_crearUsuario" type="button" onclick="confirmarBorrado()">Borrar Egreso</button></center>
                    </div>
                </form>
            </div>
        </div>
