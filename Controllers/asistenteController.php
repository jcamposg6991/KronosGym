...
Class asistenteController extends Controller{
	...
	{
		$this->model = $this->model("asistenteModel");
	}
    public function index(){
		$this->loadView('asistenteView');
	}

	public function reportes(){
		$this->loadView('asistenteReportesView');
	}

	public function reporteUsuarios(){
		$data = $this->model->getUsuarios();
		$this->loadView('asistenteReporteUsuariosView',$data);
	}

	public function usuarios(){
		$data = $this->model->getUsuarios();
		$this->loadView('asistenteUsuariosView',$data);
	}
	...
	public function crearUsuario(){
		...
		$this->loadview("asistenteCrearUsuarioView",$data,$data2);
	  }
	}
	...
	public function modificarUsuario($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $this->loadView("asistenteModificarUsuariosView",$datos);
		}
	}
	...
	if ($_SERVER['REQUEST_METHOD']=="POST") {
		...
		$this->loadView("asistenteBorrarUsuarioView",$datos);
		}
	}

	public function proveedores(){
		$data = $this->model->getProveedores();
		$this->loadView('asistenteProveedoresView',$data);
	}
	...
	public function crearProveedor(){
		...
		$this->loadview("asistenteCrearProveedorView");
	  }
	}
	...
	public function modificarProveedor($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $this->loadView("asistenteModificarProveedorView",$datos);
		}
	}
	...
	if ($_SERVER['REQUEST_METHOD']=="POST") {
		...
		$this->loadView("asistenteBorrarProveedorView",$datos);
		}
	}

	public function transacciones(){
		$this->loadView('asistenteTransaccionesView',$data);
	}

	public function ingresos(){
		$data = $this->model->getIngresos();
		$this->loadView('asistenteIngresosView',$data);
	}
	...
	public function crearIngreso(){
		...
		$this->loadview("asistenteCrearIngresoView",$data);
	  }
	}
	...
	public function modificarIngreso($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $this->loadView("asistenteModificarIngresoView",$data);
		}
	}
	...
	public function borrarIngreso($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $data = $this->model->getIngreso($id);
		  $this->loadView("asistenteBorrarIngresoView",$data);
		}
	}

	public function egresos(){
		$data = $this->model->getEgresos();
		$this->loadView('asistenteEgresosView',$data);
	}
	...
	public function crearEgreso(){
		...
		$data = $this->model->getProveedores();
		$this->loadview("asistenteCrearEgresoView",$data);
	  }
	}
	...
	public function modificarEgreso($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $this->loadView("asistenteModificarEgresoView",$data);
		}
	}
	...
	public function borrarEgreso($id=""){
		...
		if ($_SERVER['REQUEST_METHOD']=="POST") {
		  ...
		  $data = $this->model->getEgreso($id);
		  $this->loadView("asistenteBorrarEgresoView",$data);
		}
	}
